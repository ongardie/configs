...
set spell
" Underline spelling errors on the console because highlighting text in red can
" be distracting, and highlighting text with arbitrary colors can be hard to
" read.
